function Tes() {
    ...
    this.initFilters = function () {
        $("#status_tes").off();
        $("#status_tes").change(function () {
            self.initCandidatesDatatable();
        });
        $("#jurusan_siswa_tes").off();
        $("#jurusan_siswa_tes").change(function () {
            self.initCandidatesDatatable();
        });
        $("#kelas_siswa_tes").off();
        $("#kelas_siswa_tes").change(function () {
            self.initCandidatesDatatable();
        });
       $("#tahun_angkatan_tes").off();
        $("#tahun_angkatan_tes").on('keyup', function() {
            self.initCandidatesDatatable();
        });
        $('.select2').select2();
    };
    ...
    this.initCandidatesDatatable = function () {
        $('#candidates_datatable_tes').DataTable({
            "aaSorting": [[ 1, 'desc' ]],
            ...
            "ajax": {
                "type": "GET",
                "url": application.url+'/sekolah/data_kompetensi',
                "data": function ( d ) {
                    d.status_tes = $('#status_tes').val();
                    d.jurusan_tes = $('#jurusan_siswa_tes').val();
                    d.kelas_siswa_tes = $('#kelas_siswa_tes').val();
                    d.tahun_angkatan_tes = $('#tahun_angkatan_tes').val();
                },
