...
class JobBoard extends CI_Controller
{
    ...
    public function index($job_id = '')
    {
        ...
        $jobsResults = $this->AdminJobBoardModel->getJobsPH($this->session->userdata('company')['company_id']);
        $jobs = $jobsResults['records'];
        $data['jobs_total_pages'] = $jobsResults['total_pages'];
        $data['jobs_pagination'] = $jobsResults['pagination'];
        $data['jobs'] = $this->load->view('perusahaan/admin/job-board/job-list-items', compact('jobs'), TRUE);
        ...
        $this->load->view('perusahaan/admin/layout/header', $header);
        $this->load->view('perusahaan/admin/job-board/index', $data);
    }
    ...
    public function jobsList()
    {
        ...
        echo json_encode(array(
            ...
            'list' => $this->load->view('perusahaan/admin/job-board/job-list-items', compact('jobs'), TRUE),
        ));
    }
    ...
    public function candidatesList($job_id = '')
    {
        ...
        echo json_encode(array(
            ...
            'list' => $this->load->view('perusahaan/admin/job-board/candidate-list-items', compact('candidates'), TRUE),
        ));
    }
    ...
    public function assignView($type = '', $job_id = '')
    {
        ...
        $data['type'] = $type;
        $data['job_id'] = $job_id;
        echo $this->load->view('perusahaan/admin/job-board/assign', $data, TRUE);
        exit;
    }
    ...
    public function viewJob($job_id = '')
    {
        ...
        echo $this->load->view('perusahaan/admin/job-board/job-detail', compact('job'), TRUE);
    }
    ...
    public function viewResume($resume_id = '')
    {
        ...
        $data['resume'] = $this->load->view('perusahaan/admin/candidates/resume', $data, TRUE);
        $data['type'] = $resume['type'];
        $data['file'] = $resume['file'];
        echo $this->load->view('perusahaan/admin/job-board/resume', $data, TRUE);
    }
