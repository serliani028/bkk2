...
class Pages extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($default == 'home') {
            $data['page'] = 'Home | Vokasi TalentHub';
            $page = null;
      
       $this->load->view('front/layout/vokasi_header',$data);        
       $this->load->view('front/vokasi_home',$data);
        }
    }
    ...
    }		public function vokasi(){		$this->load->view('front/layout/vokasi_header');        $this->load->view('front/vokasi_home');	}
