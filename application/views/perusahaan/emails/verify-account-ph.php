...
<head>
  ...
  <title><?php echo setting('site-name'); ?> | Notifikasi Pendaftaran Perusahaan</title>
  <style type="text/css">
      ...
      <tr>
        <td class="innerpadding borderbottom">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td class="h2">
                Hallo, Akun Perusahaan Anda : <strong> <?php echo esc_output($candidate->title, 'html'); ?></strong>
              </td>
            </tr>
            <tr>
              <td class="bodycopy">
                ...
                <br />
                Email Anda : <strong><?php echo esc_output($candidate->email_ph); ?></strong>
                <br />
                <br />
                Untuk tahap selanjutnya Anda akan dihubungi oleh Team Kami untuk memverifikasi Perusahaan Anda.
              </td>
            </tr>
            <tr>
                ...
                <table class="buttonwrapper" bgcolor="#e05443" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td class="button" height="45">
                      <a  >
                        Pendaftaran Akun Perusahaan Berhasil
                      </a>
                    </td>
                  </tr>
                </table>
