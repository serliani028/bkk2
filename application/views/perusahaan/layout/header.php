  ...
  <header id="header" class="fixed-top">
    <div class="container">
      <div class="logo float-left">
        <a href="<?php echo base_url(); ?>perusahaan" class="scrollto">
        ...
        <ul>
          ...
          <li style="margin-top:7px">
            ...
            <a href="<?php echo base_url(); ?>kandidat"
              title="">
              <u><b>PERGI KE KANDIDAT</b></u>
            </a>
          </li> 
          <li>
          <li style="margin-top:7px">
            &nbsp;
              <b style="border:2px solid black;padding:5px;"> HALAMAN PERUSAHAAN </b>
          </li> 
          <li>
            &nbsp;
            <a class="btn btn-primary btn-sm" href="#pendaftaran"
              title="">
              PENDAFTARAN
            </a>
          </li>
          ...
          <li>
            &nbsp;
            <?php if (PhSession()) { ?>
              <a class="btn btn-primary btn-sm" href="<?php echo base_url(); ?>jobs"
                title="<?php echo esc_output($this->session->userdata('company')['title']); ?>">
                PROFIL
              </a>
            <?php } else { ?>
              <a class="btn btn-primary btn-sm" href="<?php echo base_url(); ?>login-perusahaan">MASUK</a>
            <?php } ?>
          </li>
