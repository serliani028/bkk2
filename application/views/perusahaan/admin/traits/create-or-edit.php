<form id="admin_trait_create_update_form_ph">
  ...
  <div class="modal-footer">
    ...
    <button type="submit" class="btn btn-primary btn-blue" id="admin_trait_create_update_form_button_ph"><?php echo lang('save'); ?></button>
  </div>
</form>
