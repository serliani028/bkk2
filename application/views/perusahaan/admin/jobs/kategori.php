...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1><i class="fa fa-graduation-cap"></i> Kategori Pekerjaan <small></small></h1>
    <ol class="breadcrumb">
      <li><a href="<?php echo base_url(); ?>admin/dashboard"><i class="fas fa-tachometer-alt"></i> <?php echo lang('home'); ?></a></li>
      <li class="active"><i class="fa fa-graduation-cap"></i> Kategori Pekerjaan </li>
    </ol>
  </section>
    ...
    <div class="row">
      <div class="col-xs-12">
        <div class="box">
          ...
          <button class="btn btn-primary" data-toggle="modal" href="#modal_userDetail">Tambah Kategori Pekerjaan</button>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
            ...
            <table class="table table-bordered table-striped" id="kelas">
              ...
              <tbody>
                ...
                <td>
                  ...
                  ?>
                  <a href="<?=base_url('perusahaan/nonaktif_kategori/'.$baris->id);?>">
                  <p class="btn btn-success" style="padding:5px">Aktif </p>
                  </a>
                  <?php
                  }else{
                  ?>
                  <a href="<?=base_url('perusahaan/akftifkan_kategori/'.$baris->id);?>">
                ...
                <a href="<?=base_url('perusahaan/hapus_kategori/'.$baris->id);?>">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body" id="bodymodal_userDetail">
        ...
        <label for="input-file-now-custom-1">
          Nama Kategori <small style="color:red">* </small>
        </label>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div>
          <label for="input-file-now-custom-1">
            Kategori  <small style="color:red">* </small>
          </label>
