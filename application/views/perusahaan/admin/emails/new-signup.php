      ...
      <tr>
        <td class="innerpadding borderbottom">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td class="bodycopy">
                Seorang pengguna baru telah mendaftar dengan detail berikut di <?php echo setting('site-name'); ?>.
                <hr />
                <strong>Nama</strong> : <?php echo esc_output($candidate['first_name'].' '.$candidate['last_name'], 'html'); ?><br /><br />
