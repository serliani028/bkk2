...
<div class="login-box">
  <div class="login-logo">
    <img src="<?php echo base_url(); ?>assets/front/images/<?php echo setting('site-logo'); ?>" width="300px"/>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <a href="<?php echo base_url(); ?>admin/forgot-password"><?php echo lang('i_forgot_password'); ?></a> |  <a href="<?php echo base_url(); ?>"> Kembali Ke Halaman Utama</a> <br>
