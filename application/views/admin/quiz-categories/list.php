...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1><i class="fas fa-cube"></i> <?php echo lang('quiz_categories'); ?><small></small></h1>
    <ol class="breadcrumb">
      <li><a href="<?php echo base_url(); ?>admin/dashboard"><i class="fas fa-tachometer-alt"></i> <?php echo lang('home'); ?></a></li>
      <li class="active"><i class="far fa-list-alt"></i> <?php echo lang('quizes'); ?></li>
      <li class="active"><i class="fas fa-cube"></i> <?php echo lang('quiz_categories'); ?></li>
    </ol>
  </section>
              ...
              <div class="col-md-12">
                <div class="datatable-top-controls datatable-top-controls-filter">
                  ...
                  <button type="button" class="btn btn-primary btn-blue btn-flat create-or-edit-quiz-category">
                    <i class="fa fa-plus"></i> <?php echo lang('add_quiz_category'); ?>
                  </button>
                  <?php } ?>
                  <div class="btn-group">
