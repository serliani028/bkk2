...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1><i class="fa fa-graduation-cap"></i> Data Peserta Umum (UnPaid) <small></small></h1>
    <ol class="breadcrumb">
      <li><a href="<?php echo base_url(); ?>admin/dashboard"><i class="fas fa-tachometer-alt"></i> <?php echo lang('home'); ?></a></li>
      <li class="active"><i class="fa fa-graduation-cap"></i> Data Peserta Umum (UnPaid) </li>
    </ol>
  </section>
            ...
            <table class="table table-bordered table-striped" id="sertifikat" >
              ...
              <tbody>
                ...
                CV
                 ...
                 <?php }else{ ?>
                <button class="btn btn-warning btn-xs">CV</button>
                <?php } ?>
                    <?php if($baris->ktp != ""){?>
