...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1><i class="fa fa-graduation-cap"></i> Kelola Data Siswa  <b><?=strtoupper($mitra->nama);?></b></h1>
    <ol class="breadcrumb">
      <li><a href="<?php echo base_url(); ?>admin/dashboard"><i></i> <?php echo lang('home'); ?></a></li>
      <li class="active"><i class="fa fa-users"></i> Kelola Data Siswa</li>
    </ol>
  </section>
              ...
              <div class="col-md-12">
                ...
                <div class="datatable-top-controls datatable-top-controls-dd" >
                  <div class="input-group">
                    ...
                    <input type="hidden" id="tahun_angkatan_tes" value="<?=$id?>" >
...
<!-- page script -->
<script src="<?php echo base_url(); ?>assets/admin/js/cf/data_mitra.js"></script>
