...
<table>
  <tr>
    ...
    <td style="padding-left:20px">
      ...
      <p>
        <?php if ($resum['file_cv'] != FALSE && $resum['file_cv'] != 'vokasi'): ?>
          <a target="_blank" href="<?php echo base_url('/assets/images/candidates/'.$resum['file_cv']) ;?>"> <button class="btn btn-secondary"><b>Lihat FIle CV</b></button></a>
          <?php else: ?>
          <button class="btn btn-secondary">CV Tidak Tersedia</button>
        <?php endif; ?>
      </p>
    </td>
  </tr>
...
<table>
 ...
 <tr>
    <td >
      ...
      <p>No. Telp </p>
      <!--<p>Whatsapp </p>-->
      <?php if($resum['account_type'] == "site"){ ?>
      <p>Telegram </p>
      <p>Jabatan  </p>
      <p>Divisi  </p> 
      <?php }else{ ?>
      <?php if($resum['account_type'] == "vokasi"){ ?>
      <!--<p>Media Sosial  </p> -->
      <?php } ?>
      <p>Lembaga/ Sekolah  </p>
      <!--<p>Status Lembaga / Sekolah  </p>-->
      <p>Jurusan  </p>
      <!--<p>Semester  </p>-->
      <?php } ?>
    ...
    <td >
      ...
      <!--<p>&nbsp;&nbsp; : <b><?php echo esc_output($resum['media_sosial'],'html' ); ?></b></p>-->
       <?php } ?>
      <p>&nbsp;&nbsp; : <b><?php echo esc_output($lembaga,'html' ); ?></b></p>
      <!--<p>&nbsp;&nbsp; : <b><?php echo esc_output($status_lembaga,'html' ); ?></b></p>-->
       <?php if($resum['account_type'] != "site"){ ?>
      <p>&nbsp;&nbsp; : <b><?php echo esc_output($jurusan,'html' ); ?></b></p>
      <!--<p>&nbsp;&nbsp; : <b><?php echo esc_output($resum['semester'],'html' ); ?></b></p>-->
       <?php }?>
      
      <p>&nbsp;&nbsp; : <?php if($resum['account_type'] == "vokasi"){ echo '<b>'.$resum['nis'].'</b>'; }else{ if(empty($resum['ktp'])){ echo" File Tidak Tersedia ";}else{?><a target="_blank" href="<?php echo base_url('/assets/images/candidates/'.$resum['ktp']) ;?>" ><b>|Lihat File|</b></a><?php } } ?></p>
...
<h5><b>Kota</b> : <?=$kota?></h5>
<h5><b>Kecamatan</b> : <?=$kecamatan?></h5>
<h5><b>Kelurahan</b> : <?=$kelurahan?></h5>
<?php if($resum['address']){?>
<p><?php echo esc_output($resum['address'], 'html'); ?></p>
<?php }else{ ?>
<p>Belum Ada Alamat Lengkap</p>
<?php }?>
<!--<?php if ($resum['bio'] != ""): ?>-->
...
<!--        <?php if($qualification['marks'] == "-" || $qualification['marks'] == "") { ?>-->
<!--      File Ijazah : <b>Tidak Tersedia</b>-->
<!--        <?php }else{ ?>-->
<!--      File Ijazah : <a target="_blank" href="<?php echo base_url('/assets/images/candidates/'.$qualification['marks']) ;?>"  >| Download File |</a>-->
<!--        <?php } ?>-->
<!--    </p>-->
<!--    </li>-->
<!--  <?php } ?>-->
