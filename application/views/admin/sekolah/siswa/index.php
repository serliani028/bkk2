...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1><i class="fas fa-users"></i> Kelola Data Siswa <small></small></h1>
    <ol class="breadcrumb">
      <li><a href="<?php echo base_url(); ?>admin/dashboard"><?php echo lang('home'); ?></a></li>
      <li class="active"><i class="fas fa-users"></i> Data Siswa </li>
    </ol>
  </section>
            ...
            <table id="sertifikat" class="table"  >
              ...
              <tbody>
                ...
                <tr class="text-center">
                    ...
                    <td>
                       <a href="<?=base_url()?>sekolah/kelola-siswa-pertahun/<?=encode($key->id_tahun);?>"><b class="btn btn-xs btn-primary">
