    ...
    <div class="row">
      <div class="col-xs-12">
        <div class="box">
              ...
              <div class="col-md-12">
                ...
                <div class="datatable-top-controls datatable-top-controls-dd" >
                  <div class="input-group">
                    <span class="input-group-btn">
                      <button type="button" class="btn btn-default btn-flat"><i class="fa fa-filter"></i> Filter Hail Tes </button>
                    </span>
                    <input type="hidden" id="tahun_angkatan_psikologi" value="<?=$tahun->id?>" >
                    <select class="form-control select2" id="status_psikologi" >
                ...
                <div class="datatable-top-controls datatable-top-controls-dd" >
                  <div class="input-group">
                    ...
                    <select class="form-control select2" id="jurusan_siswa_psikologi">
                  ...
                  <div class="input-group">
                    ...
                    <!--<input type="hidden" id="tahun_angakatan_tes" value="<?=$tahun->id?>" >-->
                    <select class="form-control select2" id="kelas_siswa_psikologi">
          ...
          <!-- /.box-header -->
          <div class="box-body">
            <table class="table table-bordered table-striped" id="candidates_datatable_psikologi">
              <thead>
...
<!-- page script -->
<script src="<?php echo base_url(); ?>assets/admin/js/cf/tes_psikologi.js"></script>
