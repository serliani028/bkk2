...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1><i class="fas fa-cube"></i> <?php echo lang('blog_categories'); ?><small></small></h1>
    <ol class="breadcrumb">
      <li><a href="<?php echo base_url(); ?>admin/dashboard"><i class="fas fa-tachometer-alt"></i> <?php echo lang('home'); ?></a></li>
      <li class="active"><i class="fas fa-blog"></i> <?php echo lang('blogs'); ?></li>
      <li class="active"><i class="fas fa-cube"></i> <?php echo lang('categories'); ?></li>
    </ol>
  </section>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="datatable-top-controls datatable-top-controls-filter">
                  <?php if (allowedTo('add_blog_categories')) { ?>
                  <button type="button" class="btn btn-primary btn-blue btn-flat create-or-edit-blog-category">
                    <i class="fa fa-plus"></i> <?php echo lang('add_blog_category'); ?>
                  </button>
                  <?php } ?>
                  <div class="btn-group">
...
<!-- page script -->
<script src="<?php echo base_url(); ?>assets/admin/js/cf/blog_category.js"></script>
