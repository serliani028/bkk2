...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1><i class="fa fa-briefcase"></i> Daftar Tes Seleksi<small></small></h1>
    <ol class="breadcrumb">
      <li><a href="<?php echo base_url(); ?>admin/dashboard"><i class="fas fa-tachometer-alt"></i> <?php echo lang('home'); ?></a></li>
      <li class="active"><i class="fa fa-briefcase"></i> Daftar Tes Seleksi</li>
    </ol>
  </section>
              ...
              <div class="col-md-12">
                <div class="datatable-top-controls datatable-top-controls-filter">
                  ...
                  <button type="button" class="btn btn-primary btn-blue btn-flat create-or-edit-job">
                    <i class="fa fa-plus"></i> Tambah Tes 
                  </button>
                  <?php } ?>
                  <div class="btn-group">
                    ...
                    <ul class="dropdown-menu" role="menu">
                      <!--<li><a href="#" class="bulk-action" data-action="download-excel"><?php echo lang('download_jobs'); ?></a></li>-->
          ...
          <div class="box-body">
            ...
            <table class="table table-bordered table-striped" id="jobs_datatable">
              ...
              <tr>
                ...
                <th><?php echo lang('title'); ?> Tes Seleksi</th>
                <th>Perusahaan </th>
                <!--<th>Divisi</th>-->
                <th>Kategori</th>
