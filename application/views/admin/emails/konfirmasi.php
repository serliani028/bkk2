...
<head>
  ...
  <title><?php echo setting('site-name'); ?> | Verifikasi Pembayaran</title>
  <style type="text/css">
      ...
      <tr>
        <td class="innerpadding borderbottom">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td class="bodycopy">
                Pembayaran Anda Telah Berhasil Diverifikasi Admin. Berikut Invoice Anda :
                <br>
                <p>Tes Psikologi : <?php echo esc_output($candidate->title, 'html'); ?></p>
                <p>Harga : <?php echo esc_output($candidate->harga, 'html'); ?></p>
                <p>Status : Terbayar</p>
                <p>Diverifikasi : <?php echo esc_output($dated, 'html'); ?></p>
                
                Silahkan tunggu email selanjutnya untuk mengikuti Zoom Meeting.
              </td>
            </tr>
            <tr>
              <td class="eighth-class">
                <table class="buttonwrapper" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td>
                      <p style="background-color:green;padding:10px;border-radius:5px;color:white;border:1px solid green">
                        Telah Diverifikasi
                      </p>
                    </td>
                  </tr>
