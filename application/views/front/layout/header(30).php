...
<!--<link rel="apple-touch-icon" href="<?php echo base_url(); ?>assets/front-baru/images/apple-touch-icon.html">-->
...
<div class="header_container background-color-orange-light" style="background-color:#D83030; ">
<div class="container">
<div class="row">
<div class="col">
...
<img src="<?php echo base_url(); ?>assets/front/images/<?php echo setting('site-logo'); ?>" class="logo-text" alt="" height="50px">
</a>
</div>
...
<li><a href="#">Home</a></li>
 <li>
            ...
            <?php } else { ?>
            <div0>
               <a class="" style="padding:5px;margin:0px" href="#psikotes">Psikotes Online</a>
            </div0>
            <?php } ?>
          </li>
<!--<li class="dropdown ">-->
...
<div class=" Post-Jobs">
     <?php if (candidateSession()) { ?>
              <a class="" href="<?php echo base_url(); ?>account"
                title="<?php echo esc_output($this->session->userdata('candidate')['first_name']); ?>">
                PROFIL
              </a>
            <?php } else { ?>
...
<li><a href="#">Home</a></li>
 <li>
            ...
            <?php } else { ?>
            <div0>
               <a class="" href="#psikotes">Psikotes</a>
            </div0>
            <?php } ?>
          </li>
</ul>
