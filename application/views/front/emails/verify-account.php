          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td class="bodycopy">
                ...
                <br />
                Email Anda : <strong><?php echo esc_output($candidate->email); ?></strong>
                <br />
                <br />
                Untuk menyelesaikan Pendaftaran Anda, silahkan aktivasi akun Anda dengan mengeklik link dibawah ini.
              </td>
            </tr>
            <tr>
