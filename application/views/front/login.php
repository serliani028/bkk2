                    ...
                    <div class="row">
                      ...
                      <div class="col-md-12 col-lg-12">
                        ...
                        <div class="form-group form-group-account">
                          ...
                          <label for=""><?php echo lang('email'); ?> / NIS</label><br><br>
                      ...
                      <div class="col-md-12 col-lg-12">
                        ...
                        <div class="form-group form-group-account">
                          ...
                          <label for=""><?php echo lang('password'); ?></label><br><br>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-12 col-lg-12">
                        ...
                        <div class="form-group form-group-account">
                          ...
                          <!--<div>-->
                          <!--  Belum mempunyai akun? <a href="<?= base_url('register/vokasi') ?>">Daftar Disini</a>-->
                          <!--</div>-->
