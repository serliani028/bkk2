            ...
            <div class="col-md-12 col-lg-12 col-sm-12">
              <div class="account-box">
                <p class="account-box-heading">
                  <span >PENDAFTARAN MAGANG KAMPUS MERDEKA</span>
                 ...
                 <div class="tab">
                  ...
                  <div class="tab">
                    <div class="row">
                      ...
                      <div class="col-md-6 col-lg-6">
                        <div class="form-group form-group-account">
                          <label for="">Whatsapp <small><b>(Nomor : 628xxxxxxxxxx) </b></small><small style="color:red">*</small></label>
                          <div class="input-group mb-3">
                            <input type="text" name="whatsapp" class="form-control cek" placeholder="Whatsapp"
                            aria-label="Whatsapp" aria-describedby="basic-addon1" required="1">
                          
                          </div>
                          <small id="" class="form-text text-muted">Masukkan Whatsapp.</small>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="tab">
                    <div class="row">
                      ...
                      <div class="col-md-6 col-lg-6">
                        <div class="form-group form-group-account">
                          <label for="">Kampus / Lembaga <small style="color:red">*</small></label>
                              <br>
                          <div class="input-group mb-3">
                              <!--<div class="input-group-prepend">-->
                                <select id="medsos" class="form-control select2 cek" required="1">
                                    <option value="">Pilih Kampus / Lembaga</option>
                                    <?php foreach($kampus as $baris){ ?>
                                    <option value="<?=$baris->id_mitra;?>"><?=$baris->nama;?></option>
                                    <?php }?>
                                </select>
                                
                            <input type="text" name="level" id="medsis" class="" placeholder="Kampus / Lembaga Lainnya" value="" readonly="readonly" hidden/>
                                
                            <!--</div>-->
                           
                          </div>
                          <small id="" class="form-text text-muted">Pilih Kampus / Lembaga.</small>
                        </div>
                      </div>
                      
                      <!--<div class="col-md-6 col-lg-6">-->
                      <!--  <div class="form-group form-group-account">-->
                      <!--    <label for="">Status Kampus / Lembaga <small style="color:red">*</small></label>-->
                      <!--    <div class="input-group mb-3">-->
                      <!--      <select name="refrensi1" id="refrensi1" class="form-control cek"  required="1">-->
                      ...
                      <!--     <input type="text" name="refrensi" id="refrensi" placeholder="" class="" value="" required="" readonly="readonly" hidden/>-->
                           
                      <!--     </div>-->
                      <!--    <small id="" class="form-text text-muted">Pilih Status Kampus/Lembagas.</small>-->
                      <!--  </div>-->
                      <!--</div>-->
                      
                       <div class="col-md-6 col-lg-6">
                        <div class="form-group form-group-account">
                          <label for="">Jurusan <small style="color:red">*</small></label>
                              <br>
                          <div class="input-group mb-3">
                              <!--<div class="input-group-prepend">-->
                                <select id="medsos2" class="form-control select2 cek" required="1">
                                    <option value="">Pilih Jurusan</option>
                                    <option value="si">Informatika / Sistem Informasi</option>
                                    <option value="ekbis">Ekonomi / Bisnis</option>
                                    <option value="mipa">MIPA</option>
                                    <option value="teknik">Teknik (mesin,listrik, dll)</option>
                                    <option value="dokter">Kedokteran / Kesehatan (perawat,bidan, dll)</option>
                                    <option value="sastra">Sastra</option>
                                    <option value="tani">Pertanian</option>
                                    <option value="pendik">Pendidikan</option>
                                    <option value="ilsos">Ilmu Sosial </option>
                                    <option value="hukum">Hukum </option>
                                    <option value="psiko">Psikologi</option>
                                    <option value="sosbud">Seni dan Budaya</option>
                                    <option value="Lainnya">Lainnya</option>
                                </select>
                                
                            <input type="text" name="jurusan" id="medsis2" class="" placeholder="Jurusan Lainnya" value="" readonly="readonly" hidden/>
                      ...
                      <!-- <div class="col-md-6 col-lg-6">-->
                      <!--  <div class="form-group form-group-account">-->
                      <!--    <label for="">Semester Tempuh <small style="color:red">*</small></label>-->
                      <!--        <br>-->
                      <!--    <div class="input-group mb-3">-->
                              <!--<div class="input-group-prepend">-->
                      <!--          <select class="form-control select2 cek" name="semester" required="1">-->
                      <!--              <option value="">Pilih Semester</option>-->
                      <!--              <option value="1">Semester Satu (I)</option>-->
                      <!--              <option value="2">Semester Dua (II)</option>-->
                      <!--              <option value="3">Semester Tiga (III)</option>-->
                      <!--              <option value="4">Semester Empat (IV)</option>-->
                      <!--              <option value="5">Semester Lima (V)</option>-->
                      <!--              <option value="6">Semester Enam (VI)</option>-->
                      <!--              <option value="7">Semester Tujuh (VII)</option>-->
                      <!--              <option value="8">Semester Delapan (VIII)</option>-->
                      ...
                      <!--    </div>-->
                      <!--    <small id="" class="form-text text-muted">Pilih Semester Tempuh.</small>-->
                      <!--  </div>-->
                      <!--</div>-->
                      ...
                      <div class="col-md-6 col-lg-6">
                        ...
                        <div class="form-group form-group-account">
                            ...
                            <input type="hidden" name="account_type" value="kampus" class="form-control" required="1" />
...
$(document).ready(function(){
    ...
    if(vale == 'Lainnya'){
        ...
        $('#refrensi').removeAttr('required');
        $('#refrensi').removeAttr('class');
...
$(document).ready(function(){
    $('#medsos2').change(function () {
    var vale = $(this).val();
    if(vale == 'Lainnya'){
        $('#medsis2').removeAttr('readonly');
        $('#medsis2').removeAttr('hidden');
        $('#medsis2').attr('required', 'required');
        $('#medsis2').attr('class', 'cek');
        $('#medsis2').val('');
        $("#medsis2").show();
    }else{
        $('#medsis2').removeAttr('required');
        $('#medsis2').attr('required', 'required');
        $('#medsis2').attr('readonly', 'readonly');
        $('#medsis2').removeAttr('class');
        $('#medsis2').attr('hidden');
        $('#medsis2').val(vale);
        $("#medsis2").hide();
    }
